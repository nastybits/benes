...
Некоторые проблемы с IE5 и последующими версиями начались именно здесь. Заставляю разработчиков писать отдельный код специально под IE. 
...
Microsoft же напротив блокировала все проекте ES4 и наотрез отказывалась принимать стандарт. Хотя сам JScript.NET на тот момент сильно отличался даже от 3 версии.
